  ...
  return (
    <div className="flex flex-col gap-[1em] ">
      ...
      <div className="grid md:grid-cols-2 gap-[2em]">
        <Input
          style=" flex flex-col w-[280px] md:w-full md:grid  md:col-span-2 gap-3"
          label="address"
          ...
          errorStyle="h-[56px] rounded-md border-1  md:col-span-2 border-[#CD2C2C] px-2 active:border-[#CD2C2C] focus:outline-[#CD2C2C] focus:outline-2 focus:border-0 "
          className="h-[56px] rounded-md border-1 md:col-span-2 border-[#cfcfcf] px-2 active:border-[#D87D4A] focus:outline-[#D87D4A] focus:outline-1 focus:border-0"
