  ...
  return (
    <div className="flex flex-col gap-[1em] ">
      ...
      <div className="grid grid-cols-2 gap-[2em]">
        <Input
          style="grid col-span-2 gap-3"
          label="address"
          containerStyle="flex items-center justify-between"
          labelName="address"
          labelStyle="font-bold text-[12px] capitalize tracking-[-0.21px]"
          error={errors?.address?.message}
          errorStyle="h-[56px] rounded-md border-1 col-span-2 border-[#CD2C2C] px-2 active:border-[#CD2C2C] focus:outline-[#CD2C2C] focus:outline-2 focus:border-0"
          className="h-[56px] rounded-md border-1 col-span-2 border-[#cfcfcf] px-2 active:border-[#D87D4A] focus:outline-[#D87D4A] focus:outline-1 focus:border-0"
